...
public class project implements ActionListener {
	...
	private ResultSet rs = null;
	{
		try {
			...
			con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/project", "postgres", "pavan");
	...
	public void loadHomePage() {
		clearAll();
		Color hotLightPink = new Color(255,206,206);
		f.getContentPane().setBackground(hotLightPink);
	...
	public void loadAdminLoginPage() {
		clearAll();
		Color hotLightPink = new Color(254,190,247);
		f.getContentPane().setBackground(hotLightPink);
	...
	public void loadRequestPlacingPage() {
		Color hotLightPink = new Color(192,224,255);
		f.getContentPane().setBackground(hotLightPink);
		clearAll();
		for(int i=0;i<3;i++) {
	...
	public void loadRequestDetailsPage() {
		Color hotLightPink = new Color(192,255,238);
		f.getContentPane().setBackground(hotLightPink);
		clearAll();
	...
	public void loadICTSLoginPage() {
		Color hotLightPink = new Color(252,255,192);
		f.getContentPane().setBackground(hotLightPink);
		clearAll();
	...
	public void loadAdminPage() {
		...
		try {
			...
			requests.setText(k);
			backToHomeButton.setBounds(900,100,300,50);
	...
	public void loadHODLoginPage() {
		Color hotLightPink = new Color(214,255,209);
		f.getContentPane().setBackground(hotLightPink);
		clearAll();
